...
module RbConfig
  ...
  TOPDIR = File.dirname(__FILE__).chomp!("/lib/ruby/2.2.0/x86_64-darwin16")
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/numata/.rbenv/versions/2.2.4")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/numata/.rbenv/versions/2.2.4' '--with-openssl-dir=/usr/local/opt/openssl' '--with-readline-dir=/usr/local/opt/readline' 'CC=clang' 'CFLAGS= -O3 -Wno-error=shorten-64-to-32 ' 'LDFLAGS=-L/Users/numata/.rbenv/versions/2.2.4/lib ' 'CPPFLAGS=-I/Users/numata/.rbenv/versions/2.2.4/include '"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/numata/.rbenv/versions/2.2.4"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/Users/numata/.rbenv/versions/2.2.4/include  -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -L/Users/numata/.rbenv/versions/2.2.4/lib  -fstack-protector"
